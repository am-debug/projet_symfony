...
{
    /**
     * @Route("/", name="listeretudiants")
     */
    public function home()
    {
        return $this->render('etudiants/listeretudiants.html.twig');
    }
    /**
 ...
 /**
    ...
    /**
     * @Route("/etudiants/listeretudiants", name="listeretudiants")
     */
    public function lister(EtudiantsRepository $etudiantsRepository, PaginatorInterface $paginator, Request $request)
    {
        ...
        return $this->render('etudiants/listeretudiants.html.twig', [/* compact("etudiantss") */
            'etudiants' => $etudiants
        ]);
    }
    /**
